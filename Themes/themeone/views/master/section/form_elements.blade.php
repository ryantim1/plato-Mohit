 					 ...
 					 <fieldset class="form-group" >
						...
						{{ Form::text('section', $value = null , $attributes = array('class'=>'form-control','name'=>'section', 
							'placeholder' => getPhrase('section_title'), 
							'ng-model'=>'language', 
							'required'=> 'true', 
							'ng-class'=>'{"has-error": formSection.section.$touched && formSection.section.$invalid}',
							'ng-minlength' => '4',
							'ng-maxlength' => '40',
							)) }}
						<div class="validation-error" ng-messages="formSection.section.$error" >
				...
				<!--	<fieldset class="form-group" >
					...
					<fieldset class='form-group col-md-6'>
						...
						<div class="buttons text-center" >
							...
							ng-disabled='!formSection.$valid'>{{ $button_name }}</button>
						</div>
