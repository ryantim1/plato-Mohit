...
font-size: 20px;
    ...
    ?>
        <div class="container">
            ...
            <h1>Please update application</h1>
            <p>For updating the application please run this below command after your application name in the URL</p>
            <p>" Your Application Name/update/appication "</p>
            <p>Ex : https://Platooes/update/appication</p>
            <hr>
